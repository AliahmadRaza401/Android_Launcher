...
class LocalStorage {
  ...
  static Future<ShortcutAppsModel> getShortcutApps() async {
    ...
    return ShortcutAppsModel(
      camera: prefs.getString(ShortcutAppTypes.CAMERA.name).toString(),
      phone: prefs.getString(ShortcutAppTypes.PHONE.name).toString(),
      setting: prefs.getString(ShortcutAppTypes.SETTINGS.name).toString(),
      message: prefs.getString(ShortcutAppTypes.MESSAGE.name).toString(),
    );
  }
