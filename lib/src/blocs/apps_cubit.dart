...
class AppsCubit extends Cubit<AppsState> {
  ...
  Future<void> updateSortType(String sortType) async {
    ...
    final apps = getAppsSorted(sortType: sortType, appsToSort: []);
    emit(AppsLoaded(
        apps: apps,
        sortType: sortType,
  ...
  dynamic getCurrentPayloads(
      {required AppsStatePayloadTypes appsStatePayloadTypes}) {
  ...
  Future<ShortcutAppsModel?> getShortcutApps(List<Application> apps) async {
    ...
    try {
      ...
      if (!isNewUser) {
        ...
        final shortcutApps = ShortcutAppsModel(
  ...
  List<Application> getAppsSorted(
      {required List<Application> appsToSort, required String sortType}) {
